...
X_Train,    Y_Train     = np.array(all_data_npS[:Train_data_len]),                                np.array(close_data_npS[:Train_data_len]).ravel()
X_Test,     Y_Test      = np.array(all_data_npS[Train_data_len:Train_data_len + Test_data_len]),  np.array(close_data_npS[Train_data_len:Train_data_len + Test_data_len]).ravel()
X_Predict,  Y_Predict   = np.array(all_data_npS[Train_data_len + Test_data_len:]),                np.array(close_data_npS[Train_data_len + Test_data_len:]).ravel()
...
print(f"------------------------------")
print(f"Run with Gamma {gamma} and indicators")
print(f"---------------TESTING---------------")
